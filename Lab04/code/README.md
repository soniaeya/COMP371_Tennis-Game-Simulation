...
string cubePath = "../Assets/Models/cube.obj";
    ...
    T2.ChangeTennisPosition(translate(mat4(1.0f), T1Pos) * scale(mat4(1.0f), vec3(0.35f, 0.35f, 0.35f))); // position
    T3.ChangeTennisPosition(translate(mat4(1.0f), T2Pos)); // position
